...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50 select-none",
  {
    variants: {
      variant: {
        default:
        ...
        sticker:
          "bg-sky-sticker text-white border border-charcoal hard-shadow-hover rounded-lg text-xs font-bold uppercase tracking-wider",
      },
      size: {
