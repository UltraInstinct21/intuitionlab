...
export const topic24Visualizations: Record<string, ProblemVisualization> = {
  '24_Graph_Part_II/01-dijkstra-algorithm': {
    ...
    steps: [
      ...
      },
      {
        ...
        whyRationale: 'Shortest distance to direct neighbors 1 and 3 improves from infinity to 0 + 1 = 1.',
        nodes: [
  ...
  '24_Graph_Part_II/02-shortest-path-in-binary-maze': {
    ...
    steps: [
      ...
      },
      {
        ...
        whatHappens: 'Pop (1,2, dist=3). Neighbor (2,2) is the bottom-right destination (n-1, n-1). Next distance = 3 + 1 = 4. Return 4 immediately!',
  ...
  '24_Graph_Part_II/03-path-with-minimum-effort': {
    ...
    steps: [
      ...
      {
        title: 'Pop (1, 0, 1): Traverse Along Top Row to (0,2) and Down to (1,2)',
        whatHappens: 'From (0,1): move to (0,2) -> diff = |2-2| = 0, effort = max(1, 0) = 1. From (0,2): move to (1,2) -> diff = |2-2| = 0, effort = max(1, 0) = 1. Push (1, 1, 2).',
        ...
        codeSnippet: 'new_effort = max(1, abs(2 - 2)) # 1',
        impact: 'Time: O(log(M × N))'
      },
      {
        title: 'From (1,2): Step Down to Destination (2,2) with Minimum Effort 2',
        whatHappens: 'Alternative path: (0,0)[1] -> (1,0)[3] -> (2,0)[5] -> (2,1)[3] -> (2,2)[5]. Consecutive diffs: |3-1|=2, |5-3|=2, |3-5|=2, |5-3|=2. Max effort = 2.',
        whyRationale: 'Top route gives step (1,2)->(2,2): |5-2|=3 (effort 3). Left-bottom route gives max diff 2. Dijkstra pops (2, 2, 2) first!',
        grid: [
          ['1', 2, 2],
          ['3', 8, 2],
          ['5', '3', '5(TARGET)']
  ...
  '24_Graph_Part_II/04-cheapest-flights-within-k-stops': {
    ...
    steps: [
      {
        title: 'Initialize Bellman-Ford: Source 0 with 0 Stops Allowed (k=1)',
  ...
  '24_Graph_Part_II/05-network-delay-time': {
    ...
    steps: [
      ...
      {
        title: 'Node 3 Relays Signal to Node 4: Receives at t = 1 + 1 = 2',
        whatHappens: 'Pop (1, 1) [no outgoing]. Pop (1, 3) -> relays signal along edge 3->4 (delay 1). Node 4 receives signal at t = 1 + 1 = 2. Push (2, 4).',
        ...
        nodes: [
          ...
          { id: 4, label: '4 (t=2)', x: 260, y: 100, status: 'active' }
        ],
        edges: [
          [2, 1], [2, 3], [3, 4, 't=2']
        ],
        ...
        codeSnippet: 'heapq.heappush(min_heap, (1 + 1, 4))',
        impact: 'Time: O(log V)'
      },
      {
        title: 'All Nodes Reached: Network Delay Time = max(dist) = 2',
        whatHappens: 'Pop (2, 4). len(dist) == n (4 == 4). All nodes have received the signal. The maximum delay is max(dist.values()) = 2.',
        whyRationale: 'Because every node is reachable and the slowest node received the signal at t=2, the total network delay is 2.',
        nodes: [
          ...
          { id: 4, label: '4 (t=2:MAX)', x: 260, y: 100, status: 'target' }
        ],
        edges: [
        ...
        queueOrStack: [],
        states: {
          finalDistances: '{1:1, 2:0, 3:1, 4:2}',
  ...
  '24_Graph_Part_II/06-bellman-ford-algorithm': {
    ...
    steps: [
      ...
      },
      {
        ...
        edges: [
          [0, 1, '-1 (✓)'], [0, 2], [1, 2, '3 (✓)'], [1, 3, '2 (✓)'], [1, 4, '2 (✓)'], [3, 2], [3, 1], [4, 3, '-3']
        ],
        activeNodeId: 1,
      ...
      },
      {
        ...
        edges: [
          [0, 1], [0, 2], [1, 2], [1, 3], [1, 4], [3, 2], [3, 1], [4, 3, '-3 (RELAXED: -2)']
        ],
        activeNodeId: 3,
        visitedIds: [0, 1, 2, 3, 4],
        states: {
